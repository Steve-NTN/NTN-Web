    ...
    <Box className={classes.footer}>
      <Grid container sx={{ padding: 2 }}>
        ...
        <Grid item md={3} sm={6} xs={12}>
          <Typography className="title">Tài khoản</Typography>
        ...
        <Grid item md={3} sm={6} xs={12}>
          <Typography className="title">Địa chỉ & Liên hệ</Typography>
          <ul className={classes.menu}>
        ...
        <Grid item md={3} sm={6} xs={12} position="relative">
          <Typography className="title">Mạng xã hội</Typography>
          <Typography sx={{ margin: { md: "16px 0", xs: "8px 0" } }}>
