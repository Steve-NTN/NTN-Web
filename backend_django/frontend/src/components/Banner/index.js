...
const Banner = () => {
  ...
  return (
    <Box
      ...
      sx={{
        backgroundImage: `url(${imageList[currentBannerIndex]?.imageLink})`,
        height: { md: "calc(100vh - 72px)", xs: "calc(100vh - 56px)" },
      }}
    >
      <Box textAlign="center">
        ...
        <Typography variant="h5" className={classes.titleText}>
          Sản phẩm của chúng tôi sẽ khiến bạn hài lòng
        </Typography>
        <Button
          ...
          sx={{
            backgroundColor: "#fff",
            padding: { md: `16px 32px`, sm: `8px 16px` },
            borderRadius: 7,
            color: "#000",
            marginTop: 2,
            textTransform: "none",
            ...
            >
              <Box
                className={`${classes.dot} ${
                  index === currentBannerIndex && classes.selectedDot
                }`}
              ></Box>
            </IconButton>
          ))}
