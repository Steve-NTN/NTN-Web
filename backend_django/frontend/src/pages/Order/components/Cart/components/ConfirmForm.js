        ...
        <Grid container>
          ...
          <Grid item xs={12}>
            ...
            <Typography fontWeight={600} sx={{ mb: 3 }} align="left">
              {`Tổng tiền phải thanh toán: ${validateCommon(
                getTotal(),
                "money"
              )}`}
            </Typography>
          ...
          <Grid item xs={12}>
            ...
            <Grid container mt={2}>
              ...
              <Grid item xs={8}>
                <CustomInput
                  width="100%"
                  getValue={(value) => setOrder({ ...order, username: value })}
                  required={true}
                />
              </Grid>
            </Grid>
            ...
            <Grid container mt={2}>
              ...
              <Grid item xs={8}>
                <CustomInput
                  width="100%"
                  getValue={(value) =>
                    setOrder({ ...order, phone_number: value })
                  }
                  required={true}
                />
              </Grid>
            ...
            <Grid container mt={2}>
              ...
              <Grid item xs={8}>
                <CustomInput
                  width="100%"
                  getValue={(value) =>
                    setOrder({ ...order, ship_address: value })
                  }
                  required={true}
                />
              </Grid>
